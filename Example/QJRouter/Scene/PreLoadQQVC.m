...
#import "PreLoadQQVC.h"
#import <JavaScriptCore/JavaScriptCore.h>
#import <WebKit/WebKit.h>

static NSString *preLoadurl = @"https://qq.com";


@interface PreLoadQQVC()<WKUIDelegate,WKNavigationDelegate>
@property (nonatomic, strong) WKWebView *webView;
@end

@implementation PreLoadQQVC
- (void)viewDidLoad {
    [super viewDidLoad];
